...
describe RuleRover::Statements::Proposition do
  describe '.parse' do
  ...
  describe '#initialize' do
    context 'well formed formulas' do
      it 'inits an atomic proposition' do
        expect(RuleRover::Statements::Proposition.new("A").symbol).to eq "A"
      end
      it 'inits negated atomic proposition' do
        prop = RuleRover::Statements::Proposition.new("not", "A")
        expect(prop.operator).to eq "not"
        expect(prop.terms.map(&:symbol)).to eq ["A"]
      end
      it 'inits a complex proposition' do
        prop = RuleRover::Statements::Proposition.new("and", "A", "B")
    ...
    context 'syntax errors' do
      it 'raises when passed an operator only' do
        expect do
          RuleRover::Statements::Proposition.new("not")
        end.to raise_error(RuleRover::Statements::NotWellFormedFormula)
      end
      it 'raises when passed connective and one literal' do
        expect do
          RuleRover::Statements::Proposition.new("and", "A")
        end.to raise_error(RuleRover::Statements::NotWellFormedFormula)
      end
      it 'raises when statements contain operators' do
        expect do
          RuleRover::Statements::Proposition.new("and", "A", "or", "B", "C")
        end.to raise_error(RuleRover::Statements::NotWellFormedFormula)
      end
    end
  end
  describe '#to_s' do
    it 'returns correct string for atomic proposition' do
      expect(RuleRover::Statements::Proposition.new("A").to_s).to eq "A"
    end
    it 'returns correct string for negated proposition' do
      expect(RuleRover::Statements::Proposition.new("not", "A").to_s).to eq "not(A)"
    end
    it 'returns correct string for complex proposition' do
      aggregate_failures do
        expect(RuleRover::Statements::Proposition.new("and", "A", "B").to_s).to eq "(A and B)"
        expect(RuleRover::Statements::Proposition.new("or", "A", "B").to_s).to eq "(A or B)"
        expect(RuleRover::Statements::Proposition.new("⊃", "A", "B").to_s).to eq "(A ⊃ B)"
        expect(RuleRover::Statements::Proposition.new("≡", "A", "B").to_s).to eq "(A ≡ B)"
      end
    end
    it 'returns correct string really complex proposition' do
      term = RuleRover::Statements::Proposition.new("and", "A", "B")
      prop = RuleRover::Statements::Proposition.new("or", "C", term)
  ...
  describe 'proposition equality' do
    context 'when proposition are equal' do
      it 'returns true when atomic props are the same symbol' do
        prop_A = RuleRover::Statements::Proposition.new("A")
        prop_B = RuleRover::Statements::Proposition.new("A")
        expect(prop_A).to eq(prop_B)
      end
      it 'returns true when complex props are the same' do
        prop_A = RuleRover::Statements::Proposition.new("and", "A", "B")
        prop_B = RuleRover::Statements::Proposition.new("and", "A", "B")
        expect(prop_A).to eq(prop_B)
      end
    ...
    context 'when propositions are not equal' do
      it 'returns false when atomic props are the same symbol' do
        prop_A = RuleRover::Statements::Proposition.new("A")
        prop_B = RuleRover::Statements::Proposition.new("B")
  ...
  xdescribe 'statement equality' do
    it 'returns true for two atomics' do
      x = RuleRover::Statements::Proposition.new("A")
      y = RuleRover::Statements::Proposition.new("A")
  ...
  xdescribe 'Statement class' do
    describe '#==' do
      it 'returns true long sentence with conjuncts and disjuncts' do
        a = RuleRover::Statements::Proposition.new("A")
        b = RuleRover::Statements::Proposition.new("B")
        d = RuleRover::Statements::Proposition.new("D")
    ...
    describe '.conjuncts' do
      context 'propositions' do
        ...
        it do
          ...
          c = RuleRover::Statements::Proposition.new("C")
          d = RuleRover::Statements::Proposition.new("D")
          e = RuleRover::Statements::Proposition.new("E")
          f = RuleRover::Statements::Proposition.new("F")
      ...
      context 'complex propositions' do
        ...
        context '.move_negation_to_literals' do
          it 'eliminates double negation of atomic' do
            not_not_a = RuleRover::Statements::Proposition.new("A").not.not
